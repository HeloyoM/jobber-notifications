...
import { consumerAuthEmailMessages } from '../email.consumer';

jest.mock('@notifications/queues/connection');
jest.mock('amqplib');
jest.mock('@heloyom/shared-develope-tools')
...
describe('Email consumer', () => {
    ...
    describe('consumerAuthEmailMessages method', () => {
        ...
        it('should be called', async () => {
            ...
            jest.spyOn(connection, 'default').mockReturnValue(channel as never);
            const connectionChannel: amqp.Channel | undefined = await connection.default();
