...
describe('Email consumer', () => {
    ...
    describe('consumerAuthEmailMessages method', () => {
        it('should be called', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            jest.spyOn(connection, 'default').mockReturnValue(channel);
            const connectionChannel = yield connection.default();
            yield (0, email_consumer_1.consumerAuthEmailMessages)(connectionChannel);
